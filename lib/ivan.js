...
`;
  ...
  global.performance = load('w3/performance');
  global.fetch = load('whatwg/fetch').fetch;

  const stdout = process.stdout = new TTYWrap(1);
  const stderr = process.stderr = new TTYWrap(2);
